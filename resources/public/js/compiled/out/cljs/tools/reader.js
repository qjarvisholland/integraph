...
var G__26712 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__26712;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__26713 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26713,ch);
...
if(("\\" === ch__$1)){
var ch_26714__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_26714__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_26714__$2);
} else {
}

var G__26715 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__26715;
continue;
}
}
...
var vec__26723 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26723,(0),null);
var start_column = cljs.core.nth.call(null,vec__26723,(1),null);
...
var G__26726 = cljs.core.conj_BANG_.call(null,a,form);
a = G__26726;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__26727 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__26728 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__26728);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__26727);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__26729 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26729,(0),null);
var start_column = cljs.core.nth.call(null,vec__26729,(1),null);
...
var vec__26732 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26732,(0),null);
var end_column = cljs.core.nth.call(null,vec__26732,(1),null);
...
var vec__26735 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26735,(0),null);
var start_column = cljs.core.nth.call(null,vec__26735,(1),null);
...
var vec__26738 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26738,(0),null);
var end_column = cljs.core.nth.call(null,vec__26738,(1),null);
...
var vec__26741 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26741,(0),null);
var start_column = cljs.core.nth.call(null,vec__26741,(1),null);
...
var vec__26744 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26744,(0),null);
var end_column = cljs.core.nth.call(null,vec__26744,(1),null);
...
var sb = (function (){var G__26747 = (new goog.string.StringBuffer());
G__26747.append(initch);
...
var G__26749 = (function (){var G__26748 = sb;
G__26748.append(ch);

return G__26748;
})();
var G__26750 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__26749;
ch = G__26750;
continue;
}
...
switch (G__26753) {
case "\\":
var G__26757 = (function (){var G__26754 = sb;
G__26754.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__26754;
})();
var G__26758 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26757;
ch = G__26758;
continue;
...
break;
default:
var G__26759 = (function (){var G__26755 = sb;
G__26755.append(ch);

return G__26755;
})();
var G__26760 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26759;
ch = G__26760;
continue;
...
var vec__26761 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26761,(0),null);
var end_column = cljs.core.nth.call(null,vec__26761,(1),null);
...
var vec__26764 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26764,(0),null);
var column = cljs.core.nth.call(null,vec__26764,(1),null);
...
var vec__26769 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26769,(0),null);
var column = cljs.core.nth.call(null,vec__26769,(1),null);
...
var vec__26774 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26774,(0),null);
var column = cljs.core.nth.call(null,vec__26774,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__26779 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26779,(0),null);
var start_column = cljs.core.nth.call(null,vec__26779,(1),null);
...
var vec__26782 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26782,(0),null);
var end_column = cljs.core.nth.call(null,vec__26782,(1),null);
...
var G__26785 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__26785,true,null,opts,pending_forms);
...
var G__26786 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__26786)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__26786)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__26786)){
...
var _STAR_suppress_read_STAR__orig_val__26787 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__26788 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__26788);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__26787);
}});
...
var G__26789 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__26789,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__26789,rdr,first_line);
...
var G__26793 = matched;
var G__26794 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__26793;
finished = G__26794;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__26795 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__26796 = (function (){var or__4126__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__26796);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__26795);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__26797 = cljs.tools.reader.arg_env;
var arg_env_temp_val__26798 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__26798);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__26799 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26799,"(");
...
var G__26800 = (i + (1));
var G__26801 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4126__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__26797);
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__26802 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__26802);
...
var G__26803 = cljs.core.next.call(null,s__$1);
var G__26804 = ret;
s__$1 = G__26803;
r = G__26804;
continue;
...
var G__26805 = cljs.core.next.call(null,s);
var G__26806 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__26805;
key_vals = G__26806;
continue;
} else {
...
var gensym_env_orig_val__26811 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__26812 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__26812);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__26811);
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__26813 = token;
var G__26813__$1 = (((G__26813 == null))?null:cljs.core.subs.call(null,G__26813,(1)));
var G__26813__$2 = (((G__26813__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26813__$1));
var G__26813__$3 = (((G__26813__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26813__$2));
var G__26813__$4 = (((G__26813__$3 == null))?null:cljs.core.symbol.call(null,G__26813__$3));
if((G__26813__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__26813__$4);
}
})():(function (){var G__26814 = token;
var G__26814__$1 = (((G__26814 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26814));
if((G__26814__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26814__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__26825,reader){
...
var opts = map__26826__$1;
var eof = cljs.core.get.call(null,map__26826__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
//# sourceMappingURL=reader.js.map?rel=1731626417849
