...
var o30220 = temp__5718__auto__;
var temp__5718__auto____$1 = (o30220["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o30221 = temp__5718__auto____$1;
return (o30221["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__29578__auto__ = f;
return (o__29578__auto__["toString"]).call(o__29578__auto__);
} else {
return "";
}
}catch (e30222){var _ = e30222;
return "";
}});
...
try{var o__29578__auto___30224 = t;
(o__29578__auto___30224["cljs$lang$ctorPrWriter"]).call(o__29578__auto___30224,t,writer);
}catch (e30223){var __30225 = e30223;
}
...
var char_code = (function (){var o__29578__auto__ = (new String(char$));
return (o__29578__auto__["charCodeAt"]).call(o__29578__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__29578__auto__ = String;
return (o__29578__auto__["fromCharCode"]).call(o__29578__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__30226 = num_code;
switch (G__30226) {
case (1):
return (185);
...
var o__29578__auto__ = String;
return (o__29578__auto__["fromCharCode"]).call(o__29578__auto__,superscript_code);
});
/**
...
}catch (e30228){var _e__29585__auto__ = e30228;
return false;
}})())){
...
var vec__30229 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__30229,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o30232 = temp__5718__auto__;
var temp__5718__auto____$1 = (o30232["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o30233 = temp__5718__auto____$1;
return (o30233["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___30240 = arguments.length;
var i__4737__auto___30241 = (0);
while(true){
if((i__4737__auto___30241 < len__4736__auto___30240)){
args__4742__auto__.push((arguments[i__4737__auto___30241]));

var G__30242 = (i__4737__auto___30241 + (1));
i__4737__auto___30241 = G__30242;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__30236){
var vec__30237 = p__30236;
var ns_detector = cljs.core.nth.call(null,vec__30237,(0),null);
...
var G__30243 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__30244 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__30243;
remaining_tokens = G__30244;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq30234){
var G__30235 = cljs.core.first.call(null,seq30234);
var seq30234__$1 = cljs.core.next.call(null,seq30234);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30235,seq30234__$1);
}));
...
var vec__30248 = cljs.core.split_with.call(null,(function (p1__30247_SHARP_){
return cljs.core.not_EQ_.call(null,p1__30247_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__30248,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__30248,(1),null);
...
var vec__30254 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__30254,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__30254,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__30257 = cljs.core.rest.call(null,remaining_tokens);
var G__30258 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__30257;
name_tokens = G__30258;
continue;
} else {
...
var vec__30261 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__30261,(0),null);
var arity = cljs.core.nth.call(null,vec__30261,(1),null);
var vec__30264 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__30264,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__30264,(1),null);
var vec__30267 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__30267,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__30267,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__30267,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__30267,(3),null);
...
var vec__30273 = result;
var munged_ns = cljs.core.nth.call(null,vec__30273,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__30273,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__30273,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__30273,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__30273,(4),null);
var arity = cljs.core.nth.call(null,vec__30273,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__30277 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__30277,(0),null);
var args = cljs.core.nth.call(null,vec__30277,(1),null);
var vec__30280 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__30280,(0),null);
var name = cljs.core.nth.call(null,vec__30280,(1),null);
...
var G__30283 = (arity + (1));
var G__30284 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__30285){
var vec__30286 = p__30285;
var arity = cljs.core.nth.call(null,vec__30286,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__30286,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__30289_SHARP_){
return cljs.core.get.call(null,arities,p1__30289_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__30290_SHARP_){
return cljs.core.drop.call(null,(2),p1__30290_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___30297 = arguments.length;
var i__4737__auto___30298 = (0);
while(true){
if((i__4737__auto___30298 < len__4736__auto___30297)){
args__4742__auto__.push((arguments[i__4737__auto___30298]));

var G__30299 = (i__4737__auto___30298 + (1));
i__4737__auto___30298 = G__30299;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__30293){
var vec__30294 = p__30293;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__30294,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq30291){
var G__30292 = cljs.core.first.call(null,seq30291);
var seq30291__$1 = cljs.core.next.call(null,seq30291);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30292,seq30291__$1);
}));
...
var G__30300 = arg;
var G__30300__$1 = (((G__30300 instanceof cljs.core.Keyword))?G__30300.fqn:null);
switch (G__30300__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__30302__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__30302__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__30302__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__30302__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__30303 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__30303,(0),null);
var fn_name = cljs.core.nth.call(null,vec__30303,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__30303,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__30303,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__30303,(4),null);
var arity = cljs.core.nth.call(null,vec__30303,(5),null);
...
var o__29578__auto__ = f;
return (o__29578__auto__["getBasis"]).call(o__29578__auto__);
});
/**
...
}catch (e30307){var _e__29585__auto__ = e30307;
...
var G__30308 = (obj[cljs.core.first.call(null,path)]);
var G__30309 = cljs.core.rest.call(null,path);
obj = G__30308;
path = G__30309;
continue;
} else {
...
var _STAR_ = (function (accum,p__30310){
var vec__30311 = p__30310;
var bit = cljs.core.nth.call(null,vec__30311,(0),null);
var protocol = cljs.core.nth.call(null,vec__30311,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__30314){
var vec__30315 = p__30314;
var ns = cljs.core.nth.call(null,vec__30315,(0),null);
var name = cljs.core.nth.call(null,vec__30315,(1),null);
var selector = cljs.core.nth.call(null,vec__30315,(2),null);
...
var post_process = (function (p__30319){
var vec__30320 = p__30319;
var munged_name = cljs.core.nth.call(null,vec__30320,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__30320,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__30318_SHARP_){
return (obj[cljs.core.first.call(null,p1__30318_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1731626418995
