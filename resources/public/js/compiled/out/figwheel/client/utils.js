...
return (new CustomEvent(event_name,(function (){var obj27041 = ({"detail":data});
return obj27041;
})()));
} else {
...
var f = (function (){var pred__27048 = cljs.core._EQ_;
var expr__27049 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__27048.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__27049))){
return (function (p1__27042_SHARP_){
return console.warn(p1__27042_SHARP_);
});
} else {
if(cljs.core.truth_(pred__27048.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__27049))){
return (function (p1__27043_SHARP_){
return console.debug(p1__27043_SHARP_);
});
} else {
if(cljs.core.truth_(pred__27048.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__27049))){
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__27052){
...
var eval_fn = cljs.core.get.call(null,map__27053__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__27055_SHARP_){
return new_def.callback(p1__27055_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__27056){
var vec__27057 = p__27056;
var ky = cljs.core.nth.call(null,vec__27057,(0),null);
var v = cljs.core.nth.call(null,vec__27057,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1731626417996
